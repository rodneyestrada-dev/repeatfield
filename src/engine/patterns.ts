...
export const DEFAULT_REPEAT: RepeatSettings = {patternId:'quarter-turn-rosette',sourceZoom:1,sourceOffsetX:0,sourceOffsetY:0,sourceRotation:0,tileScale:150,gap:0,fieldRotation:0,segments:8,showGuides:false,background:'#ece8f2'};
